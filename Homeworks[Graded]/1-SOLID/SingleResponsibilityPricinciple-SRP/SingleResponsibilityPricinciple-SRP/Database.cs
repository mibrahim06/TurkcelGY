...
{
    private readonly Dictionary<int, int> _playerCoins;
    ...
    public Database()
    {
        _playerCoins = new Dictionary<int, int>();
     ...
     */
    public int GetPlayerCoins(int playerId)
    {
     ...
     */
    public void UpdatePlayerCoins(int playerId, int newCoinAmount)
    {
